...
_exponents = {l: "%i" % (i - 11) for i, l in enumerate(ascii_lowercase)}    # associative array of exponents and corresponding letters
...
def float_to_letters(flo):
    ...
    try:
        ...
        flo = flo.__round__(significant_figures + 1 + max(0, -expo_int))
        expo_int = int(floor(log10(abs(flo))))          # integer exponent
